...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // upload them to cloundinary, avatoar
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    const {oldPassword, newPassword, confirPassword} = req.body
        // check password and confirPassword
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, {}, "Password change succefuly"))
})
...
const updateAccountDetails = asyncHandler (async (req, res) => {
    ...
    const user = await User.findByIdAndUpdate(
        ...
        {
            $set : {
                fullName,  // fullName : fullName this is aware in syntax
                email  // email : email  this is syntax
            }
        },
        { new : true}
    ).select("-password")
    ...
    const channel = await User.aggregate([
        ...
        },
        {
            $addFields : {
                ...
                isSubscribed : {
                    $cond : {
                        if : {in : [req.user?._id, "$subscribers.subscriber"]}, // in is use search array and object data
                        then : true,
                        else : false
                    }
                }
